...
format = "${custom.ssh}${custom.session}$git_branch$rust$python$nodejs$time$line_break$character"
...
format = "[](fg:{{ colors.selection_bg }})[$output]($style)[](fg:{{ colors.selection_bg }})"
